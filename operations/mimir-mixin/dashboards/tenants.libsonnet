...
(import 'dashboard-utils.libsonnet') {
  ...
  ||| % {
    overrides_exporter: $.appMatcher($._config.app_names.overrides_exporter),
  ...
  [filename]:
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum(rate(cortex_distributor_requests_in_total{%(app)s, user="$user"}[$__rate_interval]))'
      ...
      .addPanel(
        ...
        $.queryPanel(
          [
            'sum(rate(cortex_distributor_received_requests_total{%(app)s, user="$user"}[$__rate_interval]))'
            % { app: $.appMatcher($._config.app_names.distributor) },
      ...
      .addPanel(
        ...
        $.queryPanel(
          [
            'sum by (reason) (rate(cortex_discarded_requests_total{%(app)s, user="$user"}[$__rate_interval]))'
            % { app: $.appMatcher($._config.app_names.distributor) },
          ],
          [
            '{{ reason }}',
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum(rate(cortex_distributor_samples_in_total{%(app)s, user="$user"}[$__rate_interval]))'
          % { app: $.appMatcher($._config.app_names.distributor) },
          'rate',
        ) +
        { legend: { show: false } } +
      ...
      .addPanel(
        ...
        $.queryPanel(
          [
            'sum(rate(cortex_distributor_received_samples_total{%(app)s, user="$user"}[$__rate_interval]))'
            % { app: $.appMatcher($._config.app_names.distributor) },
      ...
      .addPanel(
        ...
        $.queryPanel(
          [
            'sum(rate(cortex_distributor_deduped_samples_total{%(app)s, user="$user"}[$__rate_interval]))'
            % { app: $.appMatcher($._config.app_names.distributor) },
            'sum(rate(cortex_distributor_non_ha_samples_received_total{%(app)s, user="$user"}[$__rate_interval]))'
            % { app: $.appMatcher($._config.app_names.distributor) },
          ],
          [
            'deduplicated',
      ...
      .addPanel(
        ...
        $.queryPanel(
          [
            'sum by (reason) (rate(cortex_discarded_samples_total{%(app)s, user="$user"}[$__rate_interval]))'
            % { app: $.appMatcher($._config.app_names.distributor) },
            'sum by (reason) (rate(cortex_discarded_samples_total{%(app)s, user="$user"}[$__rate_interval]))'
            % { app: $.appMatcher($._config.app_names.ingester) },
          ],
          [
            '{{ reason }} (distributor)',
            '{{ reason }} (ingester)',
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum(rate(cortex_distributor_exemplars_in_total{%(app)s, user="$user"}[$__rate_interval]))'
          % { app: $.appMatcher($._config.app_names.distributor) },
          'rate',
        ) +
        { legend: { show: false } } +
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum(rate(cortex_distributor_received_exemplars_total{%(app)s, user="$user"}[$__rate_interval]))'
          % { app: $.appMatcher($._config.app_names.distributor), group_prefix_users: $._config.group_prefix_users },
          'rate',
        ) +
        { legend: { show: false } } +
        $.panelDescription(
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum by (reason) (rate(cortex_discarded_exemplars_total{%(app)s, user="$user"}[$__rate_interval]))'
          % { app: $.appMatcher($._config.app_names.distributor) },
          '{{ reason }}',
        ) +
        $.panelDescription(
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum by (app) (cortex_ingester_tsdb_symbol_table_size_bytes{%(ingester)s, user="$user"})'
          % { ingester: $.appMatcher($._config.app_names.ingester) },
          '{{ app }}',
        ) +
        { yaxes: $.yaxes('bytes') } +
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum by (app) (cortex_ingester_tsdb_storage_blocks_bytes{%(ingester)s, user="$user"})'
          % { ingester: $.appMatcher($._config.app_names.ingester) },
          '{{ app }}',
        ) +
        { yaxes: $.yaxes('bytes') } +
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.queryPanel(
          [
            'count(sum by (rule_group) (cortex_prometheus_rule_group_rules{%(app)s, user="$user"}))'
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum(cortex_prometheus_rule_group_rules{%(app)s, user="$user"})'
          % { app: $.appMatcher($._config.app_names.ruler) },
          'rules',
        ) +
        { legend: { show: false } } +
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum(rate(cortex_prometheus_rule_evaluations_total{%(app)s, user="$user"}[$__rate_interval]))'
          % { app: $.appMatcher($._config.app_names.ruler) },
          'rate',
        ) +
        { legend: { show: false } },
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum by (rule_group) (rate(cortex_prometheus_rule_evaluation_failures_total{%(app)s, user="$user"}[$__rate_interval])) > 0'
          % { app: $.appMatcher($._config.app_names.ruler) },
          '{{ rule_group }}',
        ) + { stack: true },
      )
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.tablePanel(
          [
            'topk($limit, sum by (rule_group) (cortex_prometheus_rule_group_rules{%(app)s, user="$user"}))'
            % { app: $.appMatcher($._config.app_names.ruler) },
          ],
          { 'Value #A': { alias: 'rules' } }
        )
      ...
      .addPanel(
        ...
        $.tablePanel(
          [
            'topk($limit, sum by (rule_group) (cortex_prometheus_rule_group_last_duration_seconds{%(app)s, user="$user"}))'
            % { app: $.appMatcher($._config.app_names.ruler) },
          ],
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum(rate(cortex_prometheus_notifications_sent_total{%(app)s, user="$user"}[$__rate_interval]))'
          % { app: $.appMatcher($._config.app_names.ruler) },
          'rate',
        ) +
        { legend: { show: false } },
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.failurePanel(
          'sum(rate(cortex_prometheus_notifications_errors_total{%(app)s, user="$user"}[$__rate_interval]))'
          % { app: $.appMatcher($._config.app_names.ruler) },
          'rate',
        ) +
        { legend: { show: false } },
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.panel(title) +
        $.queryPanel(
          'sum(rate(cortex_query_frontend_queries_total{%(app)s, user="$user"}[$__rate_interval]))'
          % { app: $.appMatcher($._config.app_names.query_frontend) },
          'Queries / Sec'
        )
      )
      .addPanel(
        ...
        $.queryPanel(
          [
            'sum(cortex_query_scheduler_queue_length{%(app)s, user="$user"})'
            % { app: $.appMatcher($._config.app_names.query_scheduler) },
          ],
          [
            'Queue Length',
          ],
    ...
    .addRow(
      ...
      .addPanel(
        ...
        $.queryPanel(
          'sum(rate(cortex_query_frontend_queries_total{%(app)s, user="$user"}[$__rate_interval]))'
          % { app: $.appMatcher($._config.app_names.ruler_query_frontend) },
          'Queries / Sec'
        )
      )
      .addPanel(
        ...
        $.queryPanel(
          [
            'sum(cortex_query_scheduler_queue_length{%(app)s, user="$user"})'
            % { app: $.appMatcher($._config.app_names.ruler_query_scheduler) },
          ],
          [
            'Queue Length',
          ],
