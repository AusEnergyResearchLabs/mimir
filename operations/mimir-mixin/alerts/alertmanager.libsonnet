      ...
      rules: [
        {
          ...
          annotations: {
            message: |||
              %(product)s Alertmanager {{ $labels.%(per_app_label)s }}/%(alert_instance_variable)s is failing to read tenant configurations from storage.
            ||| % $._config,
          },
        },
        {
          ...
          annotations: {
            message: |||
              %(product)s Alertmanager {{ $labels.%(per_app_label)s }}/%(alert_instance_variable)s is unable to check tenants ownership via the ring.
            ||| % $._config,
          },
        },
        {
          ...
          annotations: {
            message: |||
              %(product)s Alertmanager {{ $labels.%(per_app_label)s }}/%(alert_instance_variable)s is failing to merge partial state changes received from a replica.
            ||| % $._config,
          },
        },
        {
          ...
          annotations: {
            message: |||
              %(product)s Alertmanager {{ $labels.%(per_app_label)s }}/%(alert_instance_variable)s is failing to replicating partial state to its replicas.
            ||| % $._config,
          },
        },
        {
          ...
          annotations: {
            message: |||
              %(product)s Alertmanager {{ $labels.%(per_app_label)s }}/%(alert_instance_variable)s is unable to persist full state snaphots to remote storage.
            ||| % $._config,
          },
        },
        {
          ...
          annotations: {
            message: |||
              %(product)s Alertmanager {{ $labels.%(per_app_label)s }}/%(alert_instance_variable)s was unable to obtain some initial state when starting up.
            ||| % $._config,
          },
        },
        {
